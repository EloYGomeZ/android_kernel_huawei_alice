...
COMMON_HEAD += $(shell pwd)/vendor/hisi/include/drv/acore
COMMON_HEAD += $(shell pwd)/vendor/hisi/include/drv/common
COMMON_HEAD += $(shell pwd)/vendor/hisi/include/nv/gu/drv
COMMON_HEAD += $(shell pwd)/vendor/hisi/config/nvim/include/gu/
COMMON_HEAD += $(shell pwd)/vendor/hisi/config/product/$(OBB_PRODUCT_NAME)/include/
COMMON_HEAD += $(shell pwd)/vendor/hisi/config/product/$(OBB_PRODUCT_NAME)/config/
else
COMMON_HEAD += $(shell pwd)/vendor/hisi/ap/include/med/
