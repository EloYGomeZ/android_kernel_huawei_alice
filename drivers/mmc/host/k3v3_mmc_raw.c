...
static int k3v3_mmc_probe(struct raw_hd_struct *rhd)
{
	...
	writel((0x1 << 5)|(0x1<<21), (void *)(apanic_crgperi_ioaddr + 0x400));
	writel((0x1 << 0), (void *)(apanic_crgperi_ioaddr + 0x200));
	writel((readl(apanic_crgperi_ioaddr + 0x270)| (1 << 1)), (void *)(apanic_crgperi_ioaddr + 0x270));
	writel(((1 << 7) | 0xB), (void *)(apanic_crgperi_ioaddr + 0x494));

	writel(0x1, (void *)(apanic_crgperi_ioaddr + 0x204));
	writel(0x1, (void *)(apanic_crgperi_ioaddr + 0x200));
	writel(0x1, (void *)(apanic_crgperi_ioaddr + 0x300));
	writel((readl(apanic_crgperi_ioaddr + 0x004)| (1 << 0)| (1 << 1)), (void *)(apanic_crgperi_ioaddr + 0x004));
	writel((readl(apanic_crgperi_ioaddr + 0x028) | (1 << 3)), (void *)(apanic_crgperi_ioaddr + 0x028));

	while ((readl(apanic_crgperi_ioaddr + 0x308) & (1 << 0)) == 0) {
      		if (++dwLoopCount == 0x00100000)
	      {	          
			printk(KERN_ERR "eMMC error: DISABLE TIMEOUT!\n 1\n");
			break;
	       }
    	}
	writel(0x1, (void *)(apanic_crgperi_ioaddr + 0x304));
	dwLoopCount = 0;
	while ((readl(apanic_crgperi_ioaddr + 0x308) &(1 << 0)) != 0) {
		if (++dwLoopCount == 0x00100000)
		{
...
{
#ifdef CONFIG_ARCH_HI6XXX
	apanic_ioaddr = (void *)ioremap_nocache(0xF723D000, 0x1000);
#else
...
#ifdef CONFIG_ARCH_HI6XXX
	apanic_crgperi_ioaddr = (void *)ioremap_nocache(0xF7030000, 0x1000);
#else
